const en = {
  ...
  settings: {
    ...
    colorblindPatterns: "Color Patterns",
    colorblindPatternsHint: "Show shape glyphs on each pad for colorblind play",
  },
  iap: {
  ...
  a11y: {
    ...
    restorePurchases: "Restore purchases",
    removeAds: "Remove ads",
    padLabel: "{{color}} pad, {{position}}",
    padColor_red: "red",
    padColor_blue: "blue",
    padColor_green: "green",
    padColor_yellow: "yellow",
    padPositionTopLeft: "top left",
    padPositionTopRight: "top right",
    padPositionBottomLeft: "bottom left",
    padPositionBottomRight: "bottom right",
    applyTheme: "Apply theme",
    previewLockedTheme: "Preview locked theme",
    applySoundPack: "Apply sound pack",
    previewLockedSoundPack: "Preview locked sound pack",
    watchSequence: "Watch sequence: {{pads}}. Repeat when ready.",
