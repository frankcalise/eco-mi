const es = {
  ...
  settings: {
    ...
    colorblindPatterns: "Patrones de color",
    colorblindPatternsHint: "Mostrar formas en cada botón para jugadores daltónicos",
  },
  iap: {
  ...
  a11y: {
    ...
    restorePurchases: "Restaurar compras",
    removeAds: "Eliminar anuncios",
    padLabel: "Botón {{color}}, {{position}}",
    padColor_red: "rojo",
    padColor_blue: "azul",
    padColor_green: "verde",
    padColor_yellow: "amarillo",
    padPositionTopLeft: "arriba izquierda",
    padPositionTopRight: "arriba derecha",
    padPositionBottomLeft: "abajo izquierda",
    padPositionBottomRight: "abajo derecha",
    applyTheme: "Aplicar tema",
    previewLockedTheme: "Vista previa de tema bloqueado",
    applySoundPack: "Aplicar paquete de sonido",
    previewLockedSoundPack: "Vista previa de paquete bloqueado",
    watchSequence: "Observa la secuencia: {{pads}}. Repite cuando estés listo.",
    gameOver: "Fin del juego. Puntos {{score}}, nivel {{level}}.",
  },
  emptyStateComponent: {
    generic: {
