...
export const ACHIEVEMENTS: Achievement[] = [
  { id: "first_game", title: "First Steps", description: "Complete your first game", icon: "footsteps" },
  ...
  { id: "streak_3", title: "Consistent", description: "3-day daily challenge streak", icon: "calendar" },
  { id: "streak_7", title: "Dedicated", description: "7-day daily challenge streak", icon: "calendar-number" },
  { id: "streak_14", title: "Devotee", description: "14-day daily challenge streak", icon: "medal" },
  { id: "daily_first", title: "Daily Player", description: "Complete a daily challenge", icon: "today" },
